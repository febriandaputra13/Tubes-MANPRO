...
df_weather = pd.read_csv("/data/weather_uts.csv")
...
x_train_today, x_test_today, y_train_today, y_test_today = train_test_split(kolom_sel_features, df_label_weather_today, test_size = 0.3, random_state = 1)
...
test_new_data_buat_Today = {'Rainfall':[70, 140, 210, 280, 350], 'Humidity9am':[20, 35, 50, 75, 90], 'Humidity3pm':[20, 35, 50, 75, 90]}
